...
export const MENU_ITEMS: MenuItem[] = [
  // 1. Specials / Chef's Picks (specials)
  {
    ...
    price: 850,
    imageUrl: '/images/pasta_meat_frying.webp',
    tags: ['chef-pick'],
  ...
  // 3. Mains / Entrées (mains)
  {
    ...
    price: 450,
    imageUrl: '/images/pasta_olive_oil.webp',
    tags: ['vegetarian', 'gluten-free'],
    allergens: ['Garlic'],
    available: true,
    weightLabel: '410 GR',
  ...
  },
  {
    ...
    price: 580,
    imageUrl: '/images/pasta_taco_soup.webp',
    tags: ['vegetarian'],
  ...
  },
  {
    ...
    price: 720,
    imageUrl: '/images/pasta_shrimp_veggies.webp',
    tags: ['chef-pick'],
