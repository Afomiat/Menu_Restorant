...
export const MENU_ITEMS: MenuItem[] = [
  // 1. Specials / Chef's Picks (specials)
  {
    ...
    price: 650,
    imageUrl: '/images/spaghetti_beef_ragu.png',
    tags: ['chef-pick'],
  ...
  },
  {
    ...
    price: 1200,
    imageUrl: '/images/ribeye_steak.png',
    tags: ['chef-pick'],
    allergens: ['Dairy'],
    available: true,
    weightLabel: '450 GR'
  ...
  // 2. Starters / Appetizers (starters)
  {
    ...
    price: 320,
    imageUrl: '/images/truffle_garlic_bread.png',
    tags: ['vegetarian'],
  ...
  },
  {
    ...
    price: 480,
    imageUrl: '/images/burrata_heirloom.png',
  ...
  // 3. Mains / Entrées (mains)
  {
    ...
    price: 380,
    imageUrl: '/images/spaghetti_aglio_olio.png',
    tags: ['vegetarian', 'gluten-free'],
    allergens: ['Garlic'],
    available: true,
    weightLabel: '410 GR',
  ...
  },
  {
    ...
    price: 580,
    imageUrl: '/images/basil_pesto_pasta.png',
    tags: ['vegetarian'],
  ...
  },
  {
    ...
    price: 680,
    imageUrl: '/images/shrimp_mushroom_pasta.png',
    tags: ['spicy'],
  ...
  },
  {
    ...
    price: 850,
    imageUrl: '/images/charred_octopus.png',
  ...
  // 4. Sides (sides)
  {
    ...
    price: 250,
    imageUrl: '/images/truffle_fries.png',
    tags: ['vegetarian'],
    allergens: ['Dairy'],
    available: true,
    weightLabel: '180 GR'
  },
  {
    ...
    price: 280,
    imageUrl: '/images/charred_broccolini.png',
    tags: ['vegetarian', 'gluten-free'],
    allergens: ['Garlic'],
    available: true,
    weightLabel: '150 GR'
  ...
  // 5. Desserts (desserts)
  {
    ...
    price: 290,
    imageUrl: '/images/classic_tiramisu.png',
    tags: ['vegetarian'],
  ...
  },
  {
    ...
    price: 320,
    imageUrl: '/images/pistachio_panna_cotta.png',
    tags: ['vegetarian', 'gluten-free'],
    allergens: ['Dairy', 'Nuts'],
    available: true,
    weightLabel: '160 GR'
  ...
  // 6. Drinks (drinks)
  {
    ...
    price: 150,
    imageUrl: '/images/fresh_juice.png',
  ...
  },
  {
    ...
    price: 350,
    imageUrl: '/images/classic_mojito.png',
    tags: ['vegetarian', 'vegan', 'gluten-free'],
    available: true,
    weightLabel: '250 ML'
  },
  {
    ...
    price: 120,
    imageUrl: '/images/artisanal_coffee.png',
